...
//            layout.sectionHeadersPinToVisibleBounds = true
            ...
            let totalSpacerWidth = layout.padding * CGFloat((layout.numberOfColums - 1))
            let totalCellWidth = width - totalSpacerWidth
            let cellWidth = totalCellWidth / CGFloat(layout.numberOfColums)
